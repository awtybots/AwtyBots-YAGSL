...
public final class Constants {
  ...
  public static final class DriveConstants {
    ...
    public static final SwerveDriveKinematics kDriveKinematics = new SwerveDriveKinematics( // Kinematic layout of swerve modules
    ...
    public static final double kFrontLeftChassisAngularOffset = -Math.PI / 2; // Offset aligning front-left module encoder to chassis frame
    public static final double kFrontRightChassisAngularOffset = 0; // Offset aligning front-right module encoder to chassis frame
    public static final double kBackLeftChassisAngularOffset = Math.PI; // Offset aligning back-left module encoder to chassis frame
    public static final double kBackRightChassisAngularOffset = Math.PI / 2; // Offset aligning back-right module encoder to chassis frame
  ...
  public static final double X_SETPOINT_REEF_ALIGNMENT = 0.06; // Desired X offset from reef for scoring (previously -0.43)
  public static final double X_TOLERANCE_REEF_ALIGNMENT = 0.08; // Acceptable X error when aligning
  public static final double Y_L_SETPOINT_REEF_ALIGNMENT = 0.05; // Desired Y offset when approaching left reef side (was -0.359)

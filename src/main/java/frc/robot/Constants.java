  ...
  public static final class VisionConstants {
    public static final class Coral {
      ...
      public static final double distanceSlowZone = 1; // Slow down forward/backward speed of robot if within 1m of
                                                       // aprilTag
      public static final double strafeTolerance = 0.01; // 5 cm tolerance for strafe
      ...
      public static final double leftOffsetMeters = -0.1; // Adjust how far left to align to reach left bar on reef
      public static final double rightOffsetMeters = 0.1; // Adjust how far right to align to reach right bar on reef
    }

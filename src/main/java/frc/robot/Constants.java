...
public final class Constants {
  ...
  // If the holonomic controller feels lazy, bump these up; if the robot jitters, bring them down.
  ...
  // Shift the sign or magnitude here whenever “forward”/“left” seems flipped – the command maps these directly.

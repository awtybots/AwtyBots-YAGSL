...
public final class Constants {
  ...
  public static final double maxSpeed = Units.feetToMeters(18.84); // Maximum achievable drivetrain speed in meters per second
  ...
  public static final class DriveConstants {
    ...
    public static final double kMaxAngularSpeed = 2 * Math.PI; // Maximum commanded chassis rotation speed in radians per second

    // Chassis configuration
    public static final double kTrackWidth = Units.inchesToMeters(28); // Lateral distance between left and right module centers
    // Distance between centers of right and left wheels on robot
    public static final double kWheelBase = Units.inchesToMeters(28); // Longitudinal distance between front and rear module centers
    // Distance between front and back wheels on robot
    public static final SwerveDriveKinematics kDriveKinematics = new SwerveDriveKinematics( // Kinematic model defining module locations on chassis
    ...
    public static final double kFrontLeftChassisAngularOffset = -Math.PI / 2; // Offset to align front-left module encoder with chassis
    public static final double kFrontRightChassisAngularOffset = 0; // Offset to align front-right module encoder with chassis
    public static final double kBackLeftChassisAngularOffset = Math.PI; // Offset to align back-left module encoder with chassis
    public static final double kBackRightChassisAngularOffset = Math.PI / 2; // Offset to align back-right module encoder with chassis
  ...
  public static final class ElevatorSetpoints{
    ...
    public static final int AlgaeLow = 0; // Elevator position for low algae handling
    ...
    public static final int L3 = 0 ; // Elevator position placeholder for level 3 scoring
  ...
  public static final class ArmSetpoints{
    public static final double FeederStation = -1.3; // Arm angle for human player station pickup
    ...
    public static final double L3 = -13.583; // Arm angle for level 3 coral scoring
  ...
  public static final class ClimbSetPoints{
    ...
    public static final double kIn = 1; // Pneumatic state for pulling arms in
    public static final double kOut = -1; // Pneumatic state for pushing arms out
  }
  ...
  public static final class SafetyConstants {
    ...
    public static final double LOCK_REMINDER_INTERVAL_SECONDS = 0.75; // Interval for reminding operators to lock mechanisms
  }
  ...
  public static final class ModuleConstants {
    ...
    public static final int kDrivingMotorPinionTeeth = 14; // Selected drive pinion tooth count

    // Calculations required for driving motor conversion factors and feed forward
    public static final double kDrivingMotorFreeSpeedRps = NeoMotorConstants.kFreeSpeedRpm / 60; // Motor free speed in rotations per second
    public static final double kWheelDiameterMeters = 0.0762; // Swerve wheel diameter in meters
    public static final double kWheelCircumferenceMeters = kWheelDiameterMeters * Math.PI; // Swerve wheel circumference in meters
    // 45 teeth on the wheel's bevel gear, 22 teeth on the first-stage spur gear, 15
    // teeth on the bevel pinion
    public static final double kDrivingMotorReduction = (45.0 * 22) / (kDrivingMotorPinionTeeth * 15); // Overall drive gear reduction ratio
    public static final double kDriveWheelFreeSpeedRps = (kDrivingMotorFreeSpeedRps * kWheelCircumferenceMeters)
        / kDrivingMotorReduction; // Predicted free speed at wheel surface
  }

  public static final class OIConstants {
    public static final int kDriverControllerPort = 0; // USB port index for driver controller (duplicate for clarity)
    ...
    public static final double kTriggerThreshold = 0.2; // Threshold for treating triggers as pressed
  }
  ...
  public static final double Y_REEF_ALIGNMENT_P = 2.1; // Proportional gain for Y-axis reef alignment
  ...
  public static final double ROT_SETPOINT_REEF_ALIGNMENT = 0; // Desired heading when aligned to the reef
  public static final double ROT_TOLERANCE_REEF_ALIGNMENT = 1; // Acceptable heading error during alignment
  public static final double X_SETPOINT_REEF_ALIGNMENT = 0.06; // Desired X offset to reef for scoring posture
  ...
  public static final double DONT_SEE_TAG_WAIT_TIME = 1; // Time to keep aligning after vision targets disappear
  public static final double POSE_VALIDATION_TIME = 0.12; // Duration a pose measurement must be stable
  public static final double POSE_LOSS_GRACE_PERIOD = 0.4; // Allowed time without pose updates before aborting
  public static final double POSE_ODOMETRY_TOLERANCE_METERS = 0.1; // Maximum translation difference between vision and odometry
  public static final double POSE_ODOMETRY_TOLERANCE_DEGREES = 3.0; // Maximum rotation difference between vision and odometry
  ...
  public static final int DASHBOARD_UPDATE_PERIOD_CYCLES = 10; // Number of loops between dashboard refreshes

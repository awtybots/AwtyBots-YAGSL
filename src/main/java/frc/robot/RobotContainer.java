...
public class RobotContainer {
        ...
        public RobotContainer() {
                ...
                NamedCommands.registerCommand("ElevatorLiftL1",
                                m_coralSubsystem.setSetpointCommand(Setpoint.L1, false));
                NamedCommands.registerCommand("ElevatorLiftL2",
                                m_coralSubsystem.setSetpointCommand(Setpoint.L2, false));
                NamedCommands.registerCommand("ElevatorLiftL3",
                                m_coralSubsystem.setSetpointCommand(Setpoint.L3, false));
                NamedCommands.registerCommand("ElevatorLiftL4",
                                m_coralSubsystem.setSetpointCommand(Setpoint.L4, false));
                NamedCommands.registerCommand("AlgaeLow",
                                m_coralSubsystem.setSetpointCommand(Setpoint.AlgaeLow, false));
                NamedCommands.registerCommand("AlgaeHigh",
                                m_coralSubsystem.setSetpointCommand(Setpoint.AlgaeHigh, false));
                NamedCommands.registerCommand("Gyroreset",
                                new InstantCommand(() -> drivebase.setInitialHeading(180), drivebase));
        ...
        Command scoreUniversal() {
                return Commands.select(Map.of(
                                "FUNNEL", m_EndE.BrunIntakeCommandFeeder()
                                                .andThen(m_EndE.runIntakeCommand().withTimeout(0.2)),
                                "L4", m_EndE.fastreverseintakeCommand(),
                                "DEFAULT", m_EndE.fastrunIntakeCommand()), () -> {
                                        if (CoralSubsystem.runFunnelIntake)
                                                return "FUNNEL";
                                        if (CoralSubsystem.ElevatorAtL4)
                                                return "L4";
                                ...
                                .onTrue(
                                                Commands.runOnce(() -> {
                                                        ...
                                                        driveAngulareVelocity.withControllerRotationAxis(() -> {
                                                                ...
                                                                return Math.abs(rotationValue) >= 0.5
                                                                                ? 0.5 * Math.signum(rotationValue)
                                                                                : rotationValue;
                                                        });
                                                }))
                                .onFalse(

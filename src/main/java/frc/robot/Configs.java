...
public final class Configs {
        ...
        public static final class CoralSubsystem {
                ...
                public static final SparkFlexConfig slowWristMotorConfig = new SparkFlexConfig();
                ...
                static {
                        ...
                        slowWristMotorConfig.idleMode(IdleMode.kCoast).smartCurrentLimit(50).voltageCompensation(12);
                        slowWristMotorConfig.closedLoop
                                        .feedbackSensor(FeedbackSensor.kPrimaryEncoder)
                                        .p(0.1)
                                        .outputRange(-1, 1).maxMotion
                                        .maxVelocity(2000 * 0.2)
                                        .maxAcceleration(10000 * 0.2)
                                        .allowedClosedLoopError(.25);
